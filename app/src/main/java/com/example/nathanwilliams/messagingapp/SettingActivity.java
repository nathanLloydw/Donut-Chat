            ...
            if (resultCode == RESULT_OK)
            {
                ...
                filepath.putFile(resultUri).addOnCompleteListener(new OnCompleteListener<UploadTask.TaskSnapshot>()
                {
                    ...
                    public void onComplete(@NonNull Task<UploadTask.TaskSnapshot> task)
                    {
                            ...
                            uploadTask.addOnCompleteListener(new OnCompleteListener<UploadTask.TaskSnapshot>()
                            {
                                ...
                                public void onComplete(@NonNull Task<UploadTask.TaskSnapshot> thumb_task)
                                {
                                    ...
                                    if(thumb_task.isSuccessful())
                                    {
                                        ...
                                        updateHashMap.put("thumb_image",download_url);
                                        ...
                                        mUserDatabase.updateChildren(updateHashMap).addOnCompleteListener(new OnCompleteListener<Void>()
                                        {
                                            ...
                                            public void onComplete(@NonNull Task<Void> task)
                                            {
                                                if (task.isSuccessful())
                                                {
                                                    Toast.makeText(SettingActivity.this,"sucsess",Toast.LENGTH_LONG).show();
                                    ...
                                    {
                                        Toast.makeText(SettingActivity.this,"error uploading thumbnail",Toast.LENGTH_LONG).show();
                                        mProgressDialog.dismiss();
                                    }
                        ...
                        {
                            Toast.makeText(SettingActivity.this,"error uploading profile pic",Toast.LENGTH_LONG).show();
                            mProgressDialog.dismiss();
                        }
